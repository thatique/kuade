...
func (*Point) Descriptor() ([]byte, []int) { return fileDescriptorModel, []int{0} }
...
func (*Rectangle) Descriptor() ([]byte, []int) { return fileDescriptorModel, []int{1} }
...
func (*Address) Descriptor() ([]byte, []int) { return fileDescriptorModel, []int{2} }
...
func (*UserInfo) Descriptor() ([]byte, []int) { return fileDescriptorModel, []int{4} }
...
type Credentials struct {
	...
	LastSignin time.Time `protobuf:"bytes,7,opt,name=last_signin,json=lastSignin,stdtime" json:"last_signin"`
}
